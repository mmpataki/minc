...
{
  "$end", "error", "$undefined", "NUM", "ID", "INT", "CHAR", "'('", "')'",
  "';'", "','", "'['", "']'", "$accept", "program", "declaration",
  "formal_params", "array_refs", "array_ref", "pars", "type", YY_NULLPTR
};
#endif
...
{
       2,     3,     4,     7,    10,     3,     4,    26,    11,    10,
      17,    13,    19,    11,    18,    22,    23,    21,    24,     5,
      28,    11,    25,     6,    27,     0,     0,    20
};

static const yytype_int8 yycheck[] =
{
       0,     5,     6,     4,     7,     5,     6,    10,    11,     7,
       3,    10,     4,    11,    11,     4,    12,     8,     3,     1,
      26,    11,     9,     1,    12,    -1,    -1,    13
};
...
{
       0,    14,     0,     5,     6,    15,    20,     4,    17,    18,
       7,    11,    19,    10,    15,    16,    20,     3,    11,     4,
      18,     8,     4,    12,     3,     9,    10,    12,    16
};
...
#line 1312 "y.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 69 "temp.y" /* yacc.c:1646  */
    { (yyval.oper)=(yyvsp[0].oper); }
#line 1318 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 70 "temp.y" /* yacc.c:1646  */
    { (yyval.oper)=(yyvsp[0].oper); }
